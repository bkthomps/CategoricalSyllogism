...
/**
 * Determines the major, minor, and conclusion sentences. The type of sentence is determined by the
 * letter which is associated with the specific sentence. For example, in the syllogism, AEI-3, the
 * major premise starts with all, the minor premise starts with no, and the conclusion starts with
 * some.
 */
